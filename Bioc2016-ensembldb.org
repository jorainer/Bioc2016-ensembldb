...
- _Example_: combine filters.
  ...
  #+BEGIN_SRC R
    ...
    ## 1) List all available gene biotypes:
...
+ Most of the available packages are based on UCSC data:
  - Use different genome release names than Ensembl does (e.g. /hg19/ instead of
    /GRCh37/).
...
+ _Example_: get mRNA sequences for a gene's transcripts.
  ...
  #+BEGIN_SRC R
    ...
    ## Where to get this genome's sequence? Answer: AnnotationHub!
...
+ *But*: gtf files don't provide Entrez IDs.
